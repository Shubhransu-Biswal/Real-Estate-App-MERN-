...
const About = () => {
  return (
    <div className="py-20 px-4 w-full h-[100vh] mx-auto bg-[#0d0d0dff] overflow-hidden flex justify-center items-center flex-col text-center">
      <h1 className="text-3xl font-bold mb-4 text-[#f2b700ff]">
        About Dream Dwellings
      </h1>
      <p className="mb-4 text-gray-400 max-w-[70%]">
        Dream Dwellings Estate is a leading real estate agency that specializes
