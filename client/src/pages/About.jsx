...
const About = () => {
  return (
    <div className="w-full min-h-[100vh] mx-auto bg-[#0d0d0dff] overflow-hidden flex justify-center items-center">
      <div className="w-full flex justify-center items-center flex-col text-center text-sm md:text-lg max-[493px]:mt-[10%] max-[475px]:mt-[20%] max-[418px]:mt-[60%] max-[288px]:mt-[100%]">
