...
export default function Home() {
  ...
  return (
    <div className="relative w-full h-auto overflow-hidden bg-[#0d0d0dff]">
      {/* top */}
      <div className="gap-6 max-w-[80%] mx-auto mt-[31rem] border-2 border-[#151515ff] relative -top-20 z-10 bg-[linear-gradient(to_right,#151515ff_50%,transparent_50%)]">
        <div className="max-w-[50%] p-16 px-10 flex flex-col ">
          ...
          <Link
            to={"/search"}
            className="text-xs sm:text-sm text-white mt-3 font-bold border-[3px] p-2 border-white mx-auto"
          >
            Let's Get Started...
          </Link>
        </div>
